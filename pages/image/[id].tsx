...
const ImagePage: React.FC<ImagePageProps> = ({ image, error }) => {
  ...
  return (
    <div className="flex min-h-screen w-full bg-background text-primary font-sans">
      ...
      <main className="flex-1 min-w-0 p-4 md:p-8 pb-20 md:pb-8 max-w-5xl mx-auto w-full">
        ...
        {/* Premium Image Details Layout */}
        <div className="bg-surface border border-border rounded-2xl overflow-hidden shadow-2xl grid grid-cols-1 md:grid-cols-2 gap-8 p-6 md:p-8">
